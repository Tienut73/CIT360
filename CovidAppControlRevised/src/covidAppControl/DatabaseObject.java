...
public class DatabaseObject {
	...
	public PaymentSystemObjectsFinal() {
		
	}

		// creating other constructors
		public PaymentSystemObjectsFinal(String houses, int salaryYamilka, int salaryMarisela) {
		super();
		this.houses = houses;
		...
		public String toString() {
			return "paymentSystemObjectsFinal [id=" + id + ", houses=" + houses + ", salaryYamilka=" + salaryYamilka + ", salaryMarisela=" + salaryMarisela + "]";
